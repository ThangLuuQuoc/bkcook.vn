            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form name="suaMucDich" action="{{route('suaMucDich',$mucdich->id)}}" method="POST" onsubmit="return validateForm()">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <div class="form-group">
                                    <label>Tên</label>
                                    <input class="form-control" name="ten" required value="{{$mucdich->ten}}" placeholder="nhập tên công dụng"/>
                                </div>
