    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <i class="fa fa-trash-o  fa-fw"></i><a href="{{route('xoaVideo', [$monan -> id, $video -> id])}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">Xóa</a>
                @else
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="{{route('themVideo', $monan -> id)}}" method="POST" name="themVideo" enctype="multipart/form-data">
                    ...
                    @else
                    <div class="col-md-3"><button type="submit" class="btn btn-default" disabled="">Thêm</button></div>
                    @endif
