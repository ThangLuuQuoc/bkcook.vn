...
<section id="loaimon" class="loaimon danhmucchitiet">
    <div class="container">
        ...
        <div class="item-sup gioithieu-loaimon">
            Các món súp với những đặc sản như ... chắc chắn sẽ làm hài lòng ngay cả với những ai khó tính nhất ...
        </div>

        <div class="item-lau gioithieu-loaimon">
            Các món lẩu như ...
        </div>

        <div class="item-banh gioithieu-loaimon">
            Các món bánh như ...
        </div>

        <div class="item-snack gioithieu-loaimon">
            Các món snack như với những đặc sản như ...
        </div>
