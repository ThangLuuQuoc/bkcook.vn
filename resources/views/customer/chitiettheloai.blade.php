...
<section id="theloai" class="theloai danhmucchitiet">
    <div class="container">
        ...
        <div class="item-khaivi gioithieu-theloai">
            Các món khai vị với những đặc sản như ... chắc chắn sẽ làm hài lòng ngay cả với những ai khó tính nhất ...
        </div>

        <div class="item-trangmieng gioithieu-theloai">
            Các món tráng miệng như ...
        </div>

        <div class="item-monchinh gioithieu-theloai">
            Các món chính như ...
        </div>

        <div class="item-monchay gioithieu-theloai">
            Các món chay như với những đặc sản như ...
        </div>
        ...
        <div class="danhsachcon">
            <a href="#" class="fooditem col-sm-3 col-xs-12 item-monchay">
                ...
                <span class="social">
                    <span><i class="fa fa-heart"></i> 17 món ăn</span>
