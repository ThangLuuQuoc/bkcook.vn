                        ...
                        <!-- Collect the nav links, forms, and other content for toggling -->
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#theloai" class="linktheloai">Thể Loại</a></li>
                                    <li><a href="#loaimon" class="linkloaimon">Loại Món</a></li>
                                    <li><a href="#mucdich" class="linkmucdich">Mục Đích</a></li>
                                    <li><a href="#vungmien" class="linkvungmien">Vùng Miền</a></li>
                                    <li>
                                    ...
                                    <li><a href="#monan" class="linkmonan">Món Ăn</a></li>
                                    <li><a href="dangbai" class="linkdangbai">Đăng bài</a></li>
                                    <li><a href="#nhahang-thanhvien" class="linknhahang">Nhà Hàng Liên Kết</a></li>
                                    <li><a href="#nhahang-thanhvien" class="linkthanhvien">Top Thành Viên</a></li>
