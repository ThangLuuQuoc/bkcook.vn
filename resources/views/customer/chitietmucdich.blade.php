...
<section id="mucdich" class="mucdich danhmucchitiet">
    <div class="container">
        ...
        <div class="item-giamcan gioithieu-mucdich">
            Các món giảm cân với những đặc sản như ... chắc chắn sẽ làm hài lòng ngay cả với những ai khó tính nhất ...
        </div>

        <div class="item-lamdep gioithieu-mucdich">
            Các món làm đẹp như ...
        </div>

        <div class="item-sinhnhat gioithieu-mucdich">
            Các món sinh nhật như ...
        </div>

        <div class="item-lienhoan gioithieu-mucdich">
            Các món liên hoan như với những đặc sản như ...
        </div>
