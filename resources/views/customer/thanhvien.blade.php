...
<section id="thanhvien" class="thanhvien">
    <div class="container">
        <h3 class="text-success text-center">Thành viên</h3>
        <div class="row">

            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Hùng Trần</h5>
                <img src="https://media.cooky.vn/images/blog-2016/dau-bep-viet-nam-7.png" alt="">
            ...
            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Khái Long</h5>
                <img src="http://kyluc.vn/Editor/assets/01%201%20a%20best/01%20dbca.jpg" alt="">
            ...
            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Thiên Trang Phạm</h5>
                <img src="http://media.doisongphapluat.com/508/2016/10/22/GK%20Tinh%20Hai%20chia%20se%20mon%20an%20cua%20minh.jpg" alt="">
            ...
            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Davie Lopert</h5>
                <img src="https://www.ohay.tv/file/v1/content/2015/03/bourdain-01-ohay-tv-956.jpg" alt="">
                <p class="mota">Súp, là món ăn lỏng như canh kiểu Âu, được làm bằng nhiều nguyên liệu kết hợp với nhau như thịt, cá và rau, đậu, trái cây, nước hoặc các chất lỏng khác, có thêm gia vị, thường ăn vào đầu bữa cơm kiểu Âu như một món khai vị hay bữa điểm tâm.</p>
                <span class="thechia"></span>
                <span class="social">
                    <span><i class="fa fa-cutlery"></i> 17 món ăn</span>
